...
sf::Vector2f RoundedRectangleShape::getPoint(std::size_t index) const
{
    ...
    ///////
    /// The following segment was added by Chirvasa Matei
    /// and was not part of the original source
    ///////
    ///Begin segment
    ///////
    if (myCornerPointCount * 4 == 4) {
        switch (index) {
            case 0: return {0, 0};
            case 1: return {0, mySize.y};
            case 2: return {mySize.x, mySize.y};
            case 3: return {mySize.x, 0};
        }
    }
    ///////
    ///End segment
